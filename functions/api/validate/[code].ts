  ...
  try {
    ...
    if (attestation) {
      const data = {
        ...
        logoLeftScale: attestation.logo_left_scale,
        logoRightScale: attestation.logo_right_scale,
        logoLeftX: attestation.logo_left_x,
        logoLeftY: attestation.logo_left_y,
        logoRightX: attestation.logo_right_x,
        logoRightY: attestation.logo_right_y,
