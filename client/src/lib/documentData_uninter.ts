...
export function createSubstitutionFields(profile?: Profile): SubstitutionField[] {
  ...
  return [
    ...
    // Institucional
    { id: "instituicao_polo", label: "Instituição / Polo", category: "institucional", originalValue: "CENTRO UNIVERSITÁRIO INTERNACIONAL UNINTER | POLO CURITIBA (CENTRO) - PR", currentValue: fields.instituicao_polo, pages: [3], placeholder: "UNINTER | POLO ..." },
