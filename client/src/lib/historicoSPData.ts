...
export const SP_STATE_OPTIONS: SPStateOption[] = [
  { uf: "AC", name: "ACRE", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/5/52/Bras%C3%A3o_do_Acre.svg", governmentPrefix: "DO" },
  { uf: "AL", name: "ALAGOAS", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/5/5d/Bras%C3%A3o_do_Estado_de_Alagoas.svg", governmentPrefix: "DE" },
  { uf: "AP", name: "AMAPÁ", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/6/63/Bras%C3%A3o_do_Amap%C3%A1.svg", governmentPrefix: "DO" },
  { uf: "AM", name: "AMAZONAS", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/2/23/Bras%C3%A3o_do_Amazonas.svg", governmentPrefix: "DO" },
  { uf: "BA", name: "BAHIA", brasaoUrl: BRASAO_BA_URL, governmentPrefix: "DA" },
  { uf: "CE", name: "CEARÁ", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/f/fe/Bras%C3%A3o_do_Cear%C3%A1.svg", governmentPrefix: "DO" },
  { uf: "DF", name: "DISTRITO FEDERAL", brasaoUrl: BRASAO_DF_URL, governmentPrefix: "DO" },
  { uf: "ES", name: "ESPÍRITO SANTO", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/a/a0/Bras%C3%A3o_do_Esp%C3%ADrito_Santo.svg", governmentPrefix: "DO" },
  { uf: "GO", name: "GOIÁS", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/0/06/Bras%C3%A3o_de_Goi%C3%A1s.svg", governmentPrefix: "DE" },
  { uf: "MA", name: "MARANHÃO", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/a/ab/Bras%C3%A3o_do_Maranh%C3%A3o.svg", governmentPrefix: "DO" },
  { uf: "MT", name: "MATO GROSSO", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/0/0e/Bras%C3%A3o_de_Mato_Grosso.svg", governmentPrefix: "DE" },
  { uf: "MS", name: "MATO GROSSO DO SUL", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/f/fa/Bras%C3%A3o_de_Mato_Grosso_do_Sul.svg", governmentPrefix: "DO" },
  { uf: "MG", name: "MINAS GERAIS", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/d/d2/Bras%C3%A3o_de_Minas_Gerais.svg", governmentPrefix: "DE" },
  { uf: "PA", name: "PARÁ", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/a/a4/Bras%C3%A3o_do_Par%C3%A1.svg", governmentPrefix: "DO" },
  { uf: "PB", name: "PARAÍBA", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/f/fd/Bras%C3%A3o_da_Para%C3%ADba.svg", governmentPrefix: "DA" },
  { uf: "PR", name: "PARANÁ", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/e/ec/Bras%C3%A3o_do_Paran%C3%A1.svg", governmentPrefix: "DO" },
  { uf: "PE", name: "PERNAMBUCO", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/9/90/Bras%C3%A3o_de_Pernambuco.svg", governmentPrefix: "DE" },
  { uf: "PI", name: "PIAUÍ", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/b/bc/Bras%C3%A3o_do_Piau%C3%AD.svg", governmentPrefix: "DO" },
  { uf: "RJ", name: "RIO DE JANEIRO", brasaoUrl: BRASAO_RJ_URL, governmentPrefix: "DO" },
  { uf: "RN", name: "RIO GRANDE DO NORTE", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/1/1a/Bras%C3%A3o_do_Rio_Grande_do_Norte.svg", governmentPrefix: "DO" },
  { uf: "RS", name: "RIO GRANDE DO SUL", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/2/29/Bras%C3%A3o_do_Rio_Grande_do_Sul.svg", governmentPrefix: "DO" },
  { uf: "RO", name: "RONDÔNIA", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/f/f1/Bras%C3%A3o_de_Rond%C3%B4nia.svg", governmentPrefix: "DE" },
  { uf: "RR", name: "RORAIMA", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/e/ed/Bras%C3%A3o_de_Roraima.svg", governmentPrefix: "DE" },
  { uf: "SC", name: "SANTA CATARINA", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/a/a2/Bras%C3%A3o_de_Santa_Catarina.svg", governmentPrefix: "DE" },
  { uf: "SP", name: "SÃO PAULO", brasaoUrl: BRASAO_SP_URL, governmentPrefix: "DE" },
  { uf: "SE", name: "SERGIPE", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/5/52/Bras%C3%A3o_de_Sergipe.svg", governmentPrefix: "DE" },
  { uf: "TO", name: "TOCANTINS", brasaoUrl: "https://upload.wikimedia.org/wikipedia/commons/0/05/Bras%C3%A3o_do_Tocantins.svg", governmentPrefix: "DO" },
];
