...
const PeticaoDocument = forwardRef<HTMLDivElement, PetitionSTJDocumentProps>(
  ({ data }, ref) => {
    ...
    return (
      ...
      >
        {/* ─── Layer de Fundo: Marca d'Água (Centrada e Subida 1 Linha) ─── */}
        <div style={{
          position: "absolute",
          top: "50%",
          left: "50%",
        ...
        {/* ─── Cabeçalho Superior Centralizado (Brasão Aumentado +4%) ─── */}
        <div style={{ position: "absolute", top: MARGIN_TOP - 48, left: "50%", transform: "translateX(-50%)", textAlign: "center", width: "100%", zIndex: 11, fontFamily: "'Liberation Sans', Helvetica" }}>
           <img src="/assets/peticao/brasao_republica.png" style={{ width: "95.6pt", marginBottom: "4pt", display: "inline-block" }} alt="Brasão" />
        ...
        {/* Logo OAB (Aumentado +6% e Subido 1%) */}
        <div style={{ position: "absolute", top: "-13pt", left: "4pt", zIndex: 11 }}>
           <img src="/assets/peticao/oab_logo.png" style={{ width: "91.8pt" }} alt="OAB" />
        </div>

        {/* Título do Documento (Processo Judiciário Aumentado +2%) */}
