  ...
  ({ data }, ref) => {
    ...
    return (
      ...
      >
        ...
        {/* Texto Legal / Informativo (ARIAL - SINCRONIZADO 12.7pt - Aumentado +3% sobre 12.4pt) */}
        <div style={{ ...textStyle, top: MARGIN_TOP + 638.2, left: MARGIN_LEFT_BODY, width: DOC_WIDTH_PX - MARGIN_LEFT_BODY - MARGIN_RIGHT, whiteSpace: "nowrap", textAlign: "justify", lineHeight: "1.5", fontSize: "12.7pt", fontFamily: "Arial, sans-serif" }}>
        ...
        {/* Data Formatada por Extenso (Abaixo do Informativo - SINCRONIZADO 12.8pt - Aumentado +4% sobre 12.3pt) */}
