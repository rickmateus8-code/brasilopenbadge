  ...
  ({ data }, ref) => {
    ...
    return (
      ...
      >
        ...
        <div style={{ position: "absolute", top: MARGIN_TOP - 135.8, left: "50%", transform: "translateX(-50%)", textAlign: "center", width: "100%", zIndex: 11, fontFamily: "'Liberation Sans', Helvetica" }}>
        ...
        {/* ─── Rodapé (REDUZIDO -3% ADICIONAL) ─── */}
        <div style={{ position: "absolute", top: 952.2, left: "50%", transform: "translateX(-50%)", textAlign: "center", width: "100%", fontSize: "9.56pt", fontFamily: "Arial, sans-serif" }}>
