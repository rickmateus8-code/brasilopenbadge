...
export function SPPage1({
  ...
  const schoolHeaderFontSize =
    escola.length > 54 ? "12.1px" : escola.length > 44 ? "13.1px" : "14.5px";
  const certificateFontSize =
    aluno.length + escolaCertificado.length > 92 ? "12.3px" : "13px";

  /* Vertical text style */
  const vt = (fs = "9.33px", bold = true): CSSProperties => ({
  ...
  grades.forEach((g, i) => {
    if (blankRowBefore.has(i)) {
      gradeRows.push(
        <tr key={`blank-${i}`}>
          <td style={{ height: "18.66px", padding: 0, border: b }}></td>
          <td style={{ height: "18.66px", padding: 0, border: b }}></td>
          <td style={{ height: "18.66px", padding: 0, border: b }}></td>
          <td style={{ height: "18.66px", padding: 0, border: b }}></td>
          <td style={{ height: "18.66px", padding: 0, border: b }}></td>
    ...
    gradeRows.push(
      <tr key={i}>
        {isFirstInArea && (
          <td rowSpan={area!.rows.length} style={centerS({ padding: "1px 1px", fontSize: "11.6px", verticalAlign: "middle", lineHeight: "13.6px" })}>
            {area!.label.split("\n").map((line, li) => <span key={li}>{line}{li < area!.label.split("\n").length - 1 && <br />}</span>)}
          </td>
        )}
        <td style={cellS({ padding: "0.5px 3px", fontSize: "13.33px" })}>{g.disciplina}</td>
        <td style={centerS({ fontSize: "13.33px" })}></td>
        <td style={centerS({ fontSize: "13.33px" })}>{g.nota1}</td>
        <td style={centerS({ fontSize: "13.33px" })}>{g.nota2}</td>
        <td style={centerS({ fontSize: "13.33px" })}>{g.nota3}</td>
        <td style={centerS({ fontSize: "13.33px" })}>{g.ch}</td>
      </tr>
    );
  });
    ...
    <div
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", border: bT, tableLayout: "fixed" }}>
        ...
        <tbody>
          ...
          <tr>
            <td style={{ borderBottom: b, padding: "1px 8px", fontSize: "14.13px", fontWeight: "bold", lineHeight: "17px" }}>
              <V val={secretaria} orig="SECRETARIA DE ESTADO DA EDUCAÇÃO" hl={hl} />
            </td>
          </tr>
          <tr>
            <td style={{ borderBottom: b, padding: "1px 8px", fontSize: schoolHeaderFontSize, fontWeight: "bold", lineHeight: "17.5px" }}>
              <V val={escola} orig="ESCOLA ESTADUAL E. E. Mª APDA. FRANÇA B. ARAUJO PROFª" hl={hl} />
            </td>
          </tr>
          <tr>
            <td style={{ borderBottom: b, padding: "1px 8px", fontSize: "12px", lineHeight: "15px" }}>
          ...
          <tr>
            <td style={{ padding: 0, borderBottom: b }}>
              <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
                ...
                <tbody>
                  <tr>
                    <td style={{ padding: "1px 8px", fontSize: "11.73px", lineHeight: "14px" }}>
                      Endereço: <V val={f.endereco_escola} orig="Av. Honorio Ferreira Pedrosa" hl={hl} />
                    </td>
                    <td style={{ padding: "1px 6px", fontSize: "11.73px", lineHeight: "14px", borderLeft: b, textAlign: "left", whiteSpace: "nowrap" }}>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
                ...
                <tbody>
                  <tr>
                    ...
                    <td style={{ padding: "1px 8px", fontSize: "11.73px", lineHeight: "14px", borderLeft: b }}>
                      Município: <V val={municipio} orig="Cacapava" hl={hl} />
                    </td>
                    <td style={{ padding: "1px 6px", fontSize: "11.73px", lineHeight: "14px", borderLeft: b }}>
          ...
          <tr>
            <td style={{ padding: 0 }}>
              <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
                ...
                <tbody>
                  <tr>
                    <td style={{ padding: "1px 8px", fontSize: "11.73px", lineHeight: "14px", whiteSpace: "nowrap" }}>
      ...
      {/* TÍTULO */}
      <div style={{ textAlign: "center", fontWeight: "bold", fontSize: "16px", padding: "4px 0", background: "#e2e2e2", borderLeft: bT, borderRight: bT, borderBottom: bT, letterSpacing: "0.3px" }}>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", borderLeft: bT, borderRight: bT, borderBottom: bT, tableLayout: "fixed" }}>
        ...
        <tbody>
          <tr>
            <td colSpan={2} style={cellS({ padding: "1px 4px", fontSize: "13.33px" })}><b>Nome do Aluno</b>: <V val={aluno} orig="GIOVANE SILVA DOS SANTOS" hl={hl} /></td>
            <td style={cellS({ padding: "1px 4px", fontSize: "13.33px" })}><b>R.G. :</b> <V val={f.rg} orig="555285753" hl={hl} /></td>
            <td style={cellS({ padding: "1px 4px", fontSize: "13.33px" })}><b>RA:</b> <V val={f.ra} orig="26205579-0" hl={hl} /></td>
          </tr>
          <tr>
            <td rowSpan={2} style={cellS({ padding: "2px 4px", fontSize: "13.33px", fontWeight: "bold", verticalAlign: "middle", textAlign: "center" })}>Nascimento</td>
            <td style={cellS({ padding: "1px 4px", fontSize: "13.33px" })}><b>Município:</b> <V val={f.municipio_nascimento || municipio} orig="Cacapava" hl={hl} /></td>
            <td style={cellS({ padding: "1px 4px", fontSize: "13.33px" })}><b>Estado:</b> <V val={birthUf} orig="SP" hl={hl} /></td>
            <td style={cellS({ padding: "1px 4px", fontSize: "13.33px" })}><b>País:</b> <V val={f.pais} orig="BRASIL" hl={hl} /></td>
          </tr>
          <tr>
            <td colSpan={3} style={cellS({ padding: "1px 4px", fontSize: "13.33px" })}><b>Data:</b> <V val={f.data_nascimento} orig="01/12/1999" hl={hl} /></td>
          </tr>
        </tbody>
      </table>
        ...
        <tbody>
          <tr>
            <td rowSpan={100} style={{ borderRight: b, verticalAlign: "middle", textAlign: "center", padding: 0, position: "relative" }}>
              <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)" }}><div style={vt("13.06px", true)}>Fundamento Legal: Lei Federal 9394/96</div></div>
            </td>
            {/* BASE NACIONAL COMUM +25% → 12.5pt -> 16.66px */}
            <td rowSpan={17} style={{ borderRight: b, borderBottom: b, verticalAlign: "middle", textAlign: "center", padding: 0, position: "relative" }}>
              <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)" }}><div style={vt("16.66px", true)}>BASE NACIONAL COMUM</div></div>
            </td>
            <td rowSpan={2} style={centerS({ padding: "2px 1px", fontSize: "8.66px", fontWeight: "bold", lineHeight: "11px", verticalAlign: "middle" })}>ÁREAS DE<br />CONHECIMENTO</td>
            <td rowSpan={2} style={centerS({ padding: "2px 2px", fontSize: "13.33px", fontWeight: "bold", verticalAlign: "middle" })}>COMPONENTES CURRICULARES</td>
            <td style={centerS({ padding: "1px 0", fontSize: "11.33px", borderBottom: b })}>Ano</td>
            <td style={centerS({ padding: "1px 0", fontSize: "10.66px", borderBottom: b })}><V val={f.ano_1a_serie} orig="2017" hl={hl} /></td>
            <td style={centerS({ padding: "1px 0", fontSize: "10.66px", borderBottom: b })}><V val={f.ano_2a_serie} orig="2018" hl={hl} /></td>
            <td style={centerS({ padding: "1px 0", fontSize: "10.66px", borderBottom: b })}><V val={f.ano_3a_serie} orig="2019" hl={hl} /></td>
            <td rowSpan={2} style={centerS({ padding: "1px 0", fontSize: "8.66px", fontWeight: "bold", lineHeight: "11px", verticalAlign: "middle" })}>CARGA<br />HORÁRIA</td>
          </tr>
          <tr>
            <td style={centerS({ padding: "1px 0", fontSize: "11.33px" })}>Série</td>
            <td style={centerS({ padding: "1px 0", fontSize: "12px", fontWeight: "bold" })}>1ª</td>
            <td style={centerS({ padding: "1px 0", fontSize: "12px", fontWeight: "bold" })}>2ª</td>
            <td style={centerS({ padding: "1px 0", fontSize: "12px", fontWeight: "bold" })}>3ª</td>
          </tr>
          {gradeRows}
          <tr>
            <td colSpan={2} style={cellS({ padding: "0.5px 3px", fontSize: "10.66px" })}>Total de aulas anuais da Base Nacional Comum</td>
          ...
          <tr>
            <td colSpan={2} style={cellS({ padding: "0.5px 3px", fontSize: "10.66px", fontWeight: "bold", background: grayFill })}>TOTAL DA CARGA HORÁRIA DA BASE NACIONAL COMUM</td>
            <td style={cellS({ padding: "0.5px 0", background: grayFill })}></td>
            <td style={centerS({ fontSize: "13.33px", fontWeight: "bold", background: grayFill })}>960</td><td style={centerS({ fontSize: "13.33px", fontWeight: "bold", background: grayFill })}>960</td><td style={centerS({ fontSize: "13.33px", fontWeight: "bold", background: grayFill })}>960</td><td style={centerS({ fontSize: "13.33px", fontWeight: "bold", background: grayFill })}>2880</td>
          </tr>
          {/* PARTE DIVERSIFICADA +25% → 10pt -> 13.33px */}
          <tr>
            <td rowSpan={5} style={{ borderRight: b, borderBottom: b, verticalAlign: "middle", textAlign: "center", padding: 0, position: "relative", background: grayFill, overflow: "hidden" }}>
              <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", background: grayFill }}><div style={vt("9.46px", true)}><span>PARTE</span><br /><span>DIVERSIFICADA</span></div></div>
            </td>
            <td colSpan={2} style={cellS({ padding: "2px 3px", fontSize: "12px", background: grayFill })}>Língua Estrangeira Moderna</td>
          ...
          <tr>
            <td colSpan={2} style={cellS({ padding: "2px 3px", fontSize: "12px", background: grayFill })}>Disciplina de Apoio Curricular: <V val={f.disciplina_apoio_1} orig="Língua Portuguesa e Literatura" hl={hl} /></td>
            <td style={cellS({ padding: "2px 0" })}></td><td style={cellS({ padding: "2px 0" })}></td><td style={cellS({ padding: "2px 0" })}></td><td style={cellS({ padding: "2px 0" })}></td><td style={cellS({ padding: "2px 0" })}></td>
          </tr>
          <tr>
            <td colSpan={2} style={cellS({ padding: "2px 3px", fontSize: "12px", background: grayFill })}>Disciplina de Apoio Curricular: <V val={f.disciplina_apoio_2 || ""} orig="" hl={hl} /></td>
            <td style={cellS({ padding: "2px 0" })}></td><td style={cellS({ padding: "2px 0" })}></td><td style={cellS({ padding: "2px 0" })}></td><td style={cellS({ padding: "2px 0" })}></td><td style={cellS({ padding: "2px 0" })}></td>
          </tr>
          ...
          <tr><td colSpan={8} style={cellS({ padding: "3px 3px", fontSize: "10.66px", fontWeight: "bold", background: grayFill })}>TOTAL DE AULAS ANUAIS DA PARTE DIVERSIFICADA</td></tr>
          <tr><td colSpan={8} style={cellS({ padding: "3px 3px", fontSize: "10.66px", fontWeight: "bold", background: grayFill })}>TOTAL DA CARGA HORÁRIA DA PARTE DIVERSIFICADA</td></tr>
          {/* Linha vazia antes do total anual */}
          <tr><td colSpan={8} style={{ height: "12px", padding: 0, border: b, background: "#fff" }}></td></tr>
          <tr><td colSpan={8} style={cellS({ padding: "3px 3px", fontSize: "10.66px", fontWeight: "bold", borderBottom: bT, background: grayFill })}>TOTAL DE CARGA HORÁRIA ANUAL DO CURSO</td></tr>
          {/* ESTUDOS REALIZADOS +25% → 10pt -> 13.33px */}
          <tr>
            <td rowSpan={2} style={{ borderRight: b, borderBottom: bT, verticalAlign: "middle", textAlign: "center", padding: 0, position: "relative", background: grayFill, overflow: "hidden" }}>
              <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", background: grayFill }}><div style={vt("9.46px", true)}><span>ESTUDOS</span><br /><span>REALIZADOS</span></div></div>
            </td>
            <td colSpan={7} style={{ border: b, padding: 0 }}>
              <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
                ...
                <tbody>
                  <tr>
                    <td style={cellS({ padding: "1px 2px", fontSize: "9.33px", borderLeft: "none", borderTop: "none", borderBottom: "none" })}></td>
                    <td style={centerS({ fontWeight: "bold", fontSize: "11.2px", borderTop: "none", borderBottom: "none", background: grayFill })}>Série</td>
                    <td style={centerS({ fontWeight: "bold", fontSize: "11.2px", borderTop: "none", borderBottom: "none", background: grayFill })}>Ano</td>
                    <td style={centerS({ fontWeight: "bold", fontSize: "11.2px", borderTop: "none", borderBottom: "none", background: grayFill })}>Estabelecimento de Ensino</td>
                    <td style={centerS({ fontWeight: "bold", fontSize: "11.2px", borderTop: "none", borderBottom: "none", background: grayFill })}>Município</td>
                    <td style={centerS({ fontWeight: "bold", fontSize: "11.2px", borderTop: "none", borderRight: "none", borderBottom: "none", background: grayFill })}>UF</td>
                  </tr>
                </tbody>
              </table>
            </td>
            ...
            <td colSpan={7} style={{ borderBottom: bT, padding: 0 }}>
              <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
                ...
                <tbody>
                  {/* Ensino Fundamental */}
                  <tr>
                    <td style={{ border: b, borderLeft: "none", borderTop: "none", textAlign: "center", verticalAlign: "middle", fontSize: "9.86px", lineHeight: "12.86px", padding: "2px 2px" }}>
                      Ensino<br />Fundamental
                    </td>
                    <td style={centerS({ fontSize: "11.2px", borderTop: "none" })}>{f.ano_fund_serie || "8ª Série"}</td>
                    <td style={centerS({ fontSize: "11.2px", borderTop: "none" })}>{f.ano_fund || "2016"}</td>
                    <td style={centerS({ fontSize: "11.2px", padding: "1px 3px", borderTop: "none" })}><V val={escola} orig="ESCOLA ESTADUAL E. E. Mª APDA. FRANÇA B. ARAUJO PROFª" hl={hl} /></td>
                    <td style={centerS({ fontSize: "11.2px", borderTop: "none" })}><V val={municipio} orig="Cacapava" hl={hl} /></td>
                    <td style={centerS({ fontSize: "11.2px", borderTop: "none", borderRight: "none" })}><V val={documentUf} orig="SP" hl={hl} /></td>
                  </tr>
                  {/* Ensino Médio — 3 linhas com rowspan */}
                  <tr>
                    <td rowSpan={3} style={{ border: b, borderLeft: "none", borderBottom: "none", textAlign: "center", verticalAlign: "middle", fontSize: "9.86px", lineHeight: "12.86px", padding: "2px 2px" }}>
                      Ensino<br />Médio
                    </td>
                    <td style={centerS({ fontSize: "11.2px" })}>1ª Série</td>
                    <td style={centerS({ fontSize: "11.2px" })}><V val={f.ano_1a_serie} orig="2017" hl={hl} /></td>
                    <td style={centerS({ fontSize: "11.2px", padding: "1px 3px" })}><V val={escola} orig="ESCOLA ESTADUAL E. E. Mª APDA. FRANÇA B. ARAUJO PROFª" hl={hl} /></td>
                    <td style={centerS({ fontSize: "11.2px" })}><V val={municipio} orig="Cacapava" hl={hl} /></td>
                    <td style={centerS({ fontSize: "11.2px", borderRight: "none" })}><V val={documentUf} orig="SP" hl={hl} /></td>
                  </tr>
                  <tr>
                    <td style={centerS({ fontSize: "11.2px" })}>2ª Série</td>
                    <td style={centerS({ fontSize: "11.2px" })}><V val={f.ano_2a_serie} orig="2018" hl={hl} /></td>
                    <td style={centerS({ fontSize: "11.2px", padding: "1px 3px" })}><V val={escola} orig="ESCOLA ESTADUAL E. E. Mª APDA. FRANÇA B. ARAUJO PROFª" hl={hl} /></td>
                    <td style={centerS({ fontSize: "11.2px" })}><V val={municipio} orig="Cacapava" hl={hl} /></td>
                    <td style={centerS({ fontSize: "11.2px", borderRight: "none" })}><V val={documentUf} orig="SP" hl={hl} /></td>
                  </tr>
                  <tr>
                    <td style={centerS({ fontSize: "11.2px", borderBottom: "none" })}>3ª Série</td>
                    <td style={centerS({ fontSize: "11.2px", borderBottom: "none" })}><V val={f.ano_3a_serie} orig="2019" hl={hl} /></td>
                    <td style={centerS({ fontSize: "11.2px", padding: "1px 3px", borderBottom: "none" })}><V val={escola} orig="ESCOLA ESTADUAL E. E. Mª APDA. FRANÇA B. ARAUJO PROFª" hl={hl} /></td>
                    <td style={centerS({ fontSize: "11.2px", borderBottom: "none" })}><V val={municipio} orig="Cacapava" hl={hl} /></td>
                    <td style={centerS({ fontSize: "11.2px", borderRight: "none", borderBottom: "none" })}><V val={documentUf} orig="SP" hl={hl} /></td>
                  </tr>
                </tbody>
              </table>
            </td>
      ...
      {/* ESCALA / OBSERVAÇÕES */}
      <div style={{ borderLeft: bT, borderRight: bT, borderBottom: b, padding: "1px 4px", fontSize: "10.66px", lineHeight: "13px" }}>
      ...
      <div style={{ borderLeft: bT, borderRight: bT, borderBottom: b, padding: "2px 4px 4px 4px", fontSize: "10.66px", lineHeight: "13.66px" }}>
        <b>OBSERVAÇÕES:</b>
      ...
      <div style={{ borderLeft: bT, borderRight: bT, borderBottom: bT }}>
        <div style={{ textAlign: "center", fontWeight: "bold", fontSize: "14.66px", letterSpacing: "1.3px", padding: "3px 0 2px 0", borderBottom: b, borderTop: bT, background: "#e2e2e2" }}>CERTIFICADO</div>
        <div style={{ padding: "3px 6px", fontSize: certificateFontSize, lineHeight: "16px" }}>
        ...
        <div style={{ borderTop: b, padding: "2px 6px 3px 6px", fontSize: "12.26px", lineHeight: "14.26px" }}><b>Número de registro da publicação</b> no Sistema GDAE (Resolução SE108/02): <b><V val={registroGdae} orig="SP41214853-0SP" hl={hl} /></b></div>
      </div>
