...
const TEXTO_RELATORIO_TEMPLATE = () => `Declaro para os devidos fins que a paciente acima encontra-se em acompanhamento médico devido ao diagnóstico:
...
Informo que a paciente permanece sem condições de exercer suas atividades profissionais pelo período estimado de dias, a contar desta data.`;
