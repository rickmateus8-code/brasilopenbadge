    ...
    async function fetchTemplate() {
      try {
        ...
        if (result.success) {
          ...
          // Inicializar form com valores padrão se necessário
          const initialForm: Record<string, any> = { id: "XXXX.XXXX" };
          result.data.fields_definition.forEach((f: any) => {
             initialForm[f.id] = "";
          });
          setForm(initialForm);
        } else {
        ...
        <div className="flex flex-1 overflow-hidden bg-gray-50">
          ...
          <main className="flex-1 relative flex flex-col overflow-hidden">
            ...
            <div id="preview-container" className="w-full h-full flex items-start justify-center overflow-hidden bg-white relative">
              <div style={{ 
                width: template.base_config.width, 
                flexShrink: 0, 
