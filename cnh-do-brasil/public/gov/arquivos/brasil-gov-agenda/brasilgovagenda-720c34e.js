var brasilgovagenda = function(e) {
    function t(i) {
        if (a[i])
            return a[i].exports;
        var r = a[i] = {
    ...
    ,
    t.p = "++resource++brasil.gov.agenda/",
    t(t.s = 1)
}([function(e, t, a) {
    "use strict";
    function i(e, t) {
    ...
    var r = function() {
        function e(e, t) {
            var a = []
              ...
              , s = void 0;
            try {
                for (var n, o = e[Symbol.iterator](); !(i = (n = o.next()).done) && (a.push(n.value),
                !t || a.length !== t); i = !0)
                    ;
            } catch (e) {
                r = !0,
      ...
      , n = function(e) {
        ...
        return (Array(t).fill("0").join("") + e).slice(-1 * t)
    }
      , o = function() {
        function e(t, a) {
            i(this, e),
            this.container = t,
            this.callback = a,
            this.agendaURL = t.getAttribute("data-url"),
            ...
            this.isMobile = !1,
            this.is3calendar = !1,
            null == this.$datePicker[0] && (this.is3calendar = !0),
            ...
            $(".portaltype-agendadiaria").length > 0) {
        ...
        return s(e, [{
            ...
            key: "update",
            value: function() {
                var e = this.year + "-" + n(this.month + 1) + "-" + n(this.day);
                $.ajax({
                    url: this.agendaURL + "/json/" + e,
                    context: this,
                    global: !1
                }).always(function(e) {
                    "function" == typeof this.callback && this.callback(e),
                    this.daysWithAppointments = [],
                    null != e[3].daysWithAppointments && (this.daysWithAppointments = e[3].daysWithAppointments),
                    this.updateMonthPicker()
                })
            }
        }, {
            key: "updateMonthPicker",
            value: function() {
                if (this.$currentPicker.datepicker("setDate", new Date(this.year,this.month,this.day)),
                !1 === this.is3calendar) {
                    var e = this.$currentPicker.datepicker("option", "monthNamesShort");
                    this.$month.html(e[this.month].toUpperCase()),
                    this.$year.html(this.year),
                    $(".monthpicker").attr("data-month", this.month),
                    $(".monthpicker").attr("data-year", this.year),
                    this.fixCalendarTitle()
                }
                !0 === this.is3calendar && this.resize()
            }
        }, {
            key: "resize",
            value: function(e) {
                var t = $(window).width() <= 767;
                if (null == e || this.isMobile !== t) {
                    this.isMobile = t;
                    var a = 1
                      , i = 3;
                    t && (a = 0,
                    i = 1),
                    this.$currentPicker.datepicker("option", "numberOfMonths", i),
                    this.$currentPicker.datepicker("option", "showCurrentAtPos", a),
                    setTimeout(function() {
                        this.$currentPicker.datepicker("option", "showCurrentAtPos", a)
                    }
                    .bind(this), 1),
            ...
            value: function() {
                ...
                setTimeout(function() {
                    var e = !0
                      ...
                      , a = void 0;
                    try {
                        for (var i, r = $(".ui-datepicker-month")[Symbol.iterator](); !(e = (i = r.next()).done); e = !0) {
                            var s = i.value;
                            s.textContent = s.textContent.slice(0, 3)
                        }
                    } catch (e) {
                        t = !0,
                        a = e
            ...
            value: function() {
                $(window).on("load", function() {
                    var e = function(e, t) {
                        this.year = t.selectedYear,
                        this.month = t.selectedMonth,
                        this.day = parseInt(t.selectedDay),
                        !0 === this.is3calendar ? (t.inline = !1,
                        window.location = this.agendaURL + "/" + this.year + "-" + n(this.month + 1) + "-" + n(this.day)) : this.update()
                    }
                      , t = function(e) {
                        var t = e.toISOString().slice(0, 10);
                        return this.daysWithAppointments.indexOf(t) >= 0 ? [!0, "ui-has-appointments", ""] : [!1, "", ""]
                    }
                      , a = function(e, t, a) {
                        this.year = a.selectedYear,
                        this.month = a.selectedMonth,
                        this.day = parseInt(a.selectedDay),
                        this.update()
                    }
                      , i = {
                        onSelect: e.bind(this),
                        beforeShowDay: t.bind(this),
                        onChangeMonthYear: a.bind(this)
                    };
                    this.is3calendar ? i.numberOfMonths = 3 : i.beforeShow = this.fixCalendarTitle.bind(this),
                    this.$currentPicker.datepicker(i),
                    this.update()
                }
                .bind(this))
            }
...
, function(e, t, a) {
    e.exports = a.p + "img/agenda_icon.png"
}
, function(e, t, a) {
    e.exports = a.p + "img/compromisso_icon.png"
}
, function(e, t) {}
, function(e, t, a) {
    "use strict";
    ...
    $(function() {
        var e = !0
          ...
          , a = void 0;
        try {
            for (var i, r = $(".agenda-tile")[Symbol.iterator](); !(e = (i = r.next()).done); e = !0) {
                var n = i.value;
                new s.default(n)
            }
        } catch (e) {
        ...
        var l = !0
          ...
          , p = void 0;
        try {
            for (var c, u = $(".dados-agenda")[Symbol.iterator](); !(l = (c = u.next()).done); l = !0) {
                var h = c.value;
                new o.default(h)
            }
        } catch (e) {
    ...
    t.default = {
        AgendaTile: s.default,
        AgendaView: o.default
    }
}
, function(e, t, a) {
    "use strict";
    ...
    var s = function() {
      ...
      , p = function() {
        function e(t) {
            ...
            this.tile = t,
            this.pageSize = 3,
            this.datepicker = new d.default(this.tile,this.onDateChange.bind(this)),
            this.initSwiper(),
        ...
        return s(e, [{
            ...
            key: "onDateChange",
            value: function(e) {
                this.updateDayPicker(e);
                var t = e[3];
                this.swiper.removeAllSlides();
                var a = $('<div class="swiper-slide"></div>');
                if (!1 === t.hasAppointment)
                    return a.addClass("no-events"),
                    a.html("Sem compromissos oficiais."),
                    void this.swiper.appendSlide(a);
                var i = !0
                  , r = !1
                  , s = void 0;
                try {
                    for (var n, o = t.items[Symbol.iterator](); !(i = (n = o.next()).done); i = !0) {
                        var l = n.value;
                        a.children().length === this.pageSize && (this.swiper.appendSlide(a),
                        ...
                        l.isNow && ($(".timestamp-cell", d).addClass("is-now"),
                        $(".timestamp-cell", d).append('<div class="now">Agora</div>')),
                        a.append(d)
                    }
                } catch (e) {
                    r = !0,
                ...
                a.children().length > 0 && this.swiper.appendSlide(a)
            }
        }, {
            key: "initSwiper",
            value: function() {
                this.swiper = new o.default("#" + this.tile.id + " .collection-events",{
                    navigation: {
            ...
            value: function(e) {
                ...
                var a = new Date(t.getAttribute("data-day"));
                this.datepicker.year = a.getFullYear(),
                this.datepicker.month = a.getMonth(),
                this.datepicker.day = a.getDate(),
                this.datepicker.$currentPicker.datepicker("setDate", a),
...
, function(e, t, a) {
    !function(t, a) {
            ...
            if (e)
                if ("string" == typeof e) {
                    ...
                    if (n.indexOf("<") >= 0 && n.indexOf(">") >= 0) {
                        ...
                        s = De.createElement(o),
                        s.innerHTML = n,
                        i = 0; i < s.childNodes.length; i += 1)
                            a.push(s.childNodes[i])
                    } else
                        for (r = t || "#" !== e[0] || e.match(/[ .<>:~]/) ? (t || De).querySelectorAll(e.trim()) : [De.getElementById(e.trim().split("#")[1])],
                        i = 0; i < r.length; i += 1)
                            r[i] && a.push(r[i])
                } else if (e.nodeType || e === Oe || e === De)
                    a.push(e);
        ...
        function c() {
            function t(t) {
                ...
                if (a) {
                    ...
                    e(a).is(o))
                        ...
                        for (var r = e(a).parents(), s = 0; s < r.length; s += 1)
                            e(r[s]).is(o) && l.apply(r[s], i)
                }
            }
            function a(e) {
            ...
            for (var i, r = [], s = arguments.length; s--; )
                r[s] = arguments[s];
            var n = r[0]
              , o = r[1]
              , l = r[2]
              , d = r[3];
            "function" == typeof r[1] && (i = r,
            n = i[0],
            l = i[1],
            d = i[2],
            o = void 0),
                ...
                for (var d = o[l], p = 0; p < this.length; p += 1) {
                    ...
                    u && u.length)
                        for (var h = u.length - 1; h >= 0; h -= 1) {
                            var v = u[h];
                            s && v.listener === s ? (c.removeEventListener(d, v.proxyListener, n),
                            u.splice(h, 1)) : s && v.listener && v.listener.dom7proxy && v.listener.dom7proxy === s ? (c.removeEventListener(d, v.proxyListener, n),
                            u.splice(h, 1)) : s || (c.removeEventListener(d, v.proxyListener, n),
                            u.splice(h, 1))
                        }
                }
            return this
        ...
        function h() {
            for (var e = [], t = arguments.length; t--; )
                e[t] = arguments[t];
            for (var a = e[0].split(" "), i = e[1], r = 0; r < a.length; r += 1)
                for (var s = a[r], n = 0; n < this.length; n += 1) {
                    var o = this[n]
                      , l = void 0;
                    try {
                        l = new Oe.CustomEvent(s,{
                            detail: i,
                            bubbles: !0,
                            cancelable: !0
                        })
                    } catch (e) {
                        l = De.createEvent("Event"),
                        l.initEvent(s, !0, !0),
                        l.detail = i
                    }
        ...
        function g() {
            if (this.length > 0) {
                var e = this[0]
                  ...
                  , s = e === Oe ? Oe.scrollY : e.scrollTop
                  , n = e === Oe ? Oe.scrollX : e.scrollLeft;
                return {
                    top: t.top + s - i,
                    left: t.left + n - r
                }
        ...
        function y(e, t) {
            ...
            if (1 === arguments.length) {
                ...
                if (this[0])
                    return Oe.getComputedStyle(this[0], null).getPropertyValue(e)
            }
        ...
        function C(e) {
            if (void 0 === e)
                return this;
            var t, a = this.length;
            return e > a - 1 ? new Ae([]) : e < 0 ? (t = a + e,
            new Ae(t < 0 ? [] : [this[t]])) : new Ae([this[e]])
        }
        function M() {
            for (var e = [], t = arguments.length; t--; )
                e[t] = arguments[t];
        ...
        function L(a) {
            for (var i = [], r = 0; r < this.length; r += 1)
                null !== this[r].parentNode && (a ? e(this[r].parentNode).is(a) && i.push(this[r].parentNode) : i.push(this[r].parentNode));
            return e(t(i))
        }
        function D(a) {
            for (var i = [], r = 0; r < this.length; r += 1)
                for (var s = this[r].parentNode; s; )
                    a ? e(s).is(a) && i.push(s) : i.push(s),
                    s = s.parentNode;
            return e(t(i))
        }
        function O(e) {
            var t = this;
            return void 0 === e ? new Ae([]) : (t.is(e) || (t = t.parents(e).eq(0)),
            t)
        }
        function A(e) {
        ...
        function N(a) {
            for (var i = [], r = 0; r < this.length; r += 1)
                for (var s = this[r].childNodes, n = 0; n < s.length; n += 1)
                    a ? 1 === s[n].nodeType && e(s[n]).is(a) && i.push(s[n]) : 1 === s[n].nodeType && i.push(s[n]);
            return new Ae(t(i))
        }
        function H() {
        ...
        function Y() {
            ...
            if (void 0 !== i) {
                ...
                var x;
                t.slidesPerColumn > 1 && (x = Math.floor(d / t.slidesPerColumn) === d / e.params.slidesPerColumn ? d : Math.ceil(d / t.slidesPerColumn) * t.slidesPerColumn,
                "auto" !== t.slidesPerView && "row" === t.slidesPerColumnFill && (x = Math.max(x, t.slidesPerView * t.slidesPerColumn)));
                for (var T, E = t.slidesPerColumn, S = x / E, C = Math.floor(d / t.slidesPerColumn), M = 0; M < d; M += 1) {
                    T = 0;
                    var k = l.eq(M);
                    if (t.slidesPerColumn > 1) {
                        ...
                        if ("column" === t.slidesPerColumnFill || "row" === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
                            if ("column" === t.slidesPerColumnFill)
                                ...
                                var I = Math.floor(M / t.slidesPerGroup);
                                z = Math.floor(M / t.slidesPerView) - I * t.slidesPerColumn,
                                $ = M - z * t.slidesPerView - I * t.slidesPerView
                            }
                            P = $ + z * x / E,
                            k.css({
                            ...
                            z = Math.floor(M / S),
                            $ = M - z * S;
                        k.css("margin-" + (e.isHorizontal() ? "top" : "left"), 0 !== z && t.spaceBetween && t.spaceBetween + "px").attr("data-swiper-column", $).attr("data-swiper-row", z)
                    }
                    if ("none" !== k.css("display")) {
                        if ("auto" === t.slidesPerView) {
                            ...
                            t.roundLengths)
                                ...
                                T = j && "border-box" === j && !Be.isIE ? V + R + W : V + X + F + R + W
                            }
                        ...
                        u.push(T),
                        t.centeredSlides ? (b = b + T / 2 + y / 2 + g,
                        0 === y && 0 !== M && (b = b - i / 2 - g),
                        0 === M && (b = b - i / 2 - g),
                        Math.abs(b) < .001 && (b = 0),
                        t.roundLengths && (b = Math.floor(b)),
                        w % t.slidesPerGroup == 0 && p.push(b),
                ...
                var q;
                if (r && s && ("slide" === t.effect || "coverflow" === t.effect) && a.css({
                ...
                t.slidesPerColumn > 1 && (e.virtualSize = (T + t.spaceBetween) * x,
                ...
                t.centeredSlides)) {
                    ...
                    for (var _ = 0; _ < p.length; _ += 1) {
                        ...
                        p[_] < e.virtualSize + p[0] && q.push(U)
                    }
                    p = q
                }
                if (!t.centeredSlides) {
        ...
        function F(t) {
            ...
            if (0 !== r.length) {
                ...
                for (var o = 0; o < r.length; o += 1) {
                    var l = r[o]
                      , d = (n + (i.centeredSlides ? a.minTranslate() : 0) - l.swiperSlideOffset) / (l.swiperSlideSize + i.spaceBetween);
                    if (i.watchSlidesVisibility) {
                        var p = -(n - l.swiperSlideOffset)
                          , c = p + a.slidesSizesGrid[o];
                        (p >= 0 && p < a.size - 1 || c > 1 && c <= a.size || p <= 0 && c >= a.size) && (a.visibleSlides.push(l),
        ...
        function W() {
            ...
            var o;
            o = n ? e.$wrapperEl.find("." + a.slideClass + '[data-swiper-slide-index="' + r + '"]') : t.eq(r),
            o.addClass(a.slideActiveClass),
            a.loop && (o.hasClass(a.slideDuplicateClass) ? i.children("." + a.slideClass + ":not(." + a.slideDuplicateClass + ')[data-swiper-slide-index="' + s + '"]').addClass(a.slideDuplicateActiveClass) : i.children("." + a.slideClass + "." + a.slideDuplicateClass + '[data-swiper-slide-index="' + s + '"]').addClass(a.slideDuplicateActiveClass));
        ...
        function j(e) {
            ...
            if (t = s.indexOf(i) >= 0 ? s.indexOf(i) : Math.floor(p / n.slidesPerGroup),
        ...
        function q(t) {
            ...
            a.clickedSlide = r,
            a.virtual && a.params.virtual.enabled ? a.clickedIndex = parseInt(e(r).attr("data-swiper-slide-index"), 10) : a.clickedIndex = e(r).index(),
        ...
        function U(e, t) {
            ...
            l = Math.floor(l)),
            r.virtualTranslate || (Ge.transforms3d ? s.transform("translate3d(" + o + "px, " + l + "px, 0px)") : s.transform("translate(" + o + "px, " + l + "px)")),
            a.previousTranslate = a.translate,
            a.translate = a.isHorizontal() ? o : l;
            var d, p = a.maxTranslate() - a.minTranslate();
            d = 0 === p ? 0 : (e - a.minTranslate()) / p,
            d !== n && a.updateProgress(e),
        ...
        function te(e, t, a, i) {
            ...
            (p || n.initialSlide || 0) === (d || 0) && a && r.emit("beforeSlideChangeStart");
            var h = -o[u];
            if (r.updateProgress(h),
            n.normalizeSlideIndex)
                for (var v = 0; v < l.length; v += 1)
                    -Math.floor(100 * h) >= Math.floor(100 * l[v]) && (s = v);
            if (r.initialized && s !== p) {
                if (!r.allowSlideNext && h < r.translate && h < r.minTranslate())
                    return !1;
                if (!r.allowSlidePrev && h > r.translate && h > r.maxTranslate() && (p || 0) !== s)
                    return !1
            }
            var f;
            return f = s > p ? "next" : s < p ? "prev" : "reset",
            c && -h === r.translate || !c && h === r.translate ? (r.updateActiveIndex(s),
            n.autoHeight && r.updateAutoHeight(),
            r.updateSlidesClasses(),
            "slide" !== n.effect && r.setTranslate(h),
            "reset" !== f && (r.transitionStart(a, f),
            r.transitionEnd(a, f)),
            !1) : (0 !== t && Ge.transition ? (r.setTransition(t),
            r.setTranslate(h),
            r.updateActiveIndex(s),
            r.updateSlidesClasses(),
            r.emit("beforeTransitionStart", t, i),
            r.transitionStart(a, f),
        ...
        function ie(e, t, a) {
            ...
            i.slideTo(i.activeIndex + r.slidesPerGroup, e, t, a)) : i.slideTo(i.activeIndex + r.slidesPerGroup, e, t, a)
        }
        function re(e, t, a) {
            function i(e) {
            ...
            var p, c = d ? r.translate : -r.translate, u = i(c), h = o.map(function(e) {
                return i(e)
            }), v = (l.map(function(e) {
                return i(e)
            }),
            o[h.indexOf(u)],
            o[h.indexOf(u) - 1]);
            return void 0 !== v && (p = l.indexOf(v)) < 0 && (p = r.activeIndex - 1),
            r.slideTo(p, e, t, a)
        }
        function se(e, t, a) {
            void 0 === e && (e = this.params.speed),
        ...
        function ne(e, t, a) {
            ...
            if (s < i.snapGrid.length - 1) {
                var n = i.rtlTranslate ? i.translate : -i.translate
                  , o = i.snapGrid[s];
                n - o > (i.snapGrid[s + 1] - o) / 2 && (r = i.params.slidesPerGroup)
            }
            return i.slideTo(r, e, t, a)
        }
        function oe() {
            var t, a = this, i = a.params, r = a.$wrapperEl, s = "auto" === i.slidesPerView ? a.slidesPerViewDynamic() : i.slidesPerView, n = a.clickedIndex;
            if (i.loop) {
                if (a.animating)
                    return;
                t = parseInt(e(a.clickedSlide).attr("data-swiper-slide-index"), 10),
                i.centeredSlides ? n < a.loopedSlides - s / 2 || n > a.slides.length - a.loopedSlides + s / 2 ? (a.loopFix(),
                n = r.children("." + i.slideClass + '[data-swiper-slide-index="' + t + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(),
                He.nextTick(function() {
                    a.slideTo(n)
                })) : a.slideTo(n) : n > a.slides.length - s ? (a.loopFix(),
                n = r.children("." + i.slideClass + '[data-swiper-slide-index="' + t + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(),
                He.nextTick(function() {
                    a.slideTo(n)
                })) : a.slideTo(n)
        ...
        function le() {
            ...
            if (a.loopFillGroupWithBlank) {
                ...
                if (s !== a.slidesPerGroup) {
                    for (var n = 0; n < s; n += 1) {
                        var o = e(De.createElement("div")).addClass(a.slideClass + " " + a.slideBlankClass);
                        i.append(o)
                    }
            ...
            r.each(function(a, i) {
                ...
                a < r.length && a >= r.length - t.loopedSlides && l.push(i),
        ...
        function de() {
            var e, t = this, a = t.params, i = t.activeIndex, r = t.slides, s = t.loopedSlides, n = t.allowSlidePrev, o = t.allowSlideNext, l = t.snapGrid, d = t.rtlTranslate;
            t.allowSlidePrev = !0,
            t.allowSlideNext = !0;
            var p = -l[i]
              , c = p - t.getTranslate();
            ...
            } else if ("auto" === a.slidesPerView && i >= 2 * s || i >= r.length - s) {
                e = -r.length + i + s,
                e += s;
                var u = t.slideTo(e, 0, !1, !0);
                u && 0 !== c && t.setTranslate((d ? -t.translate : t.translate) - c)
            }
            t.allowSlidePrev = n,
            t.allowSlideNext = o
        }
        ...
        function he(e) {
            ...
            "object" == typeof e && "length"in e)
                ...
                a.append(e);
            i.loop && t.loopCreate(),
            i.observer && Ge.observer || t.update()
        }
        function ve(e) {
            var t = this
              , a = t.params
            ...
            if ("object" == typeof e && "length"in e) {
                ...
                i.prepend(e);
            a.loop && t.loopCreate(),
            a.observer && Ge.observer || t.update(),
            t.slideTo(s, 0, !1)
        }
        function fe(e, t) {
            var a = this
            ...
            for (var h = 0; h < d.length; h += 1)
                i.append(d[h]);
            r.loop && a.loopCreate(),
            r.observer && Ge.observer || a.update(),
        ...
        function be(t) {
            ...
            if (!a.animating || !r.preventInteractionOnTransition) {
                ...
                (i.isTouchEvent || !("which"in n) || 3 !== n.which) && !(!i.isTouchEvent && "button"in n && n.button > 0 || i.isTouched && i.isMoved)) {
                    if (r.noSwiping && e(n.target).closest(r.noSwipingSelector ? r.noSwipingSelector : "." + r.noSwipingClass)[0])
                        return void (a.allowClick = !0);
                    if (!r.swipeHandler || e(n).closest(r.swipeHandler)[0]) {
                        s.currentX = "touchstart" === n.type ? n.targetTouches[0].pageX : n.pageX,
                        s.currentY = "touchstart" === n.type ? n.targetTouches[0].pageY : n.pageY;
                        var o = s.currentX
                          , l = s.currentY
                          , d = r.edgeSwipeDetection || r.iOSEdgeSwipeDetection
                          , p = r.edgeSwipeThreshold || r.iOSEdgeSwipeThreshold;
                        if (!d || !(o <= p || o >= Oe.screen.width - p)) {
                            if (He.extend(i, {
                                isTouched: !0,
                                isMoved: !1,
                            ...
                            "touchstart" !== n.type) {
                                ...
                                De.activeElement && e(De.activeElement).is(i.formElements) && De.activeElement !== n.target && De.activeElement.blur();
                                var u = c && a.allowTouchMove && r.touchStartPreventDefault;
                                (r.touchStartForcePreventDefault || u) && n.preventDefault()
                            }
                            a.emit("touchStart", n)
                        }
                    }
        ...
        function ye(t) {
            ...
            !i.isTouched)
                return void (i.startMoving && i.isScrolling && a.emit("touchMoveOpposite", o));
            if (!i.isTouchEvent || "mousemove" !== o.type) {
                ...
                if (i.isTouchEvent && r.touchReleaseOnEdges && !r.loop)
                    if (a.isVertical()) {
                        if (d < s.startY && a.translate <= a.maxTranslate() || d > s.startY && a.translate >= a.minTranslate())
                            return i.isTouched = !1,
                            void (i.isMoved = !1)
                    } else if (l < s.startX && a.translate <= a.maxTranslate() || l > s.startX && a.translate >= a.minTranslate())
                        return;
                if (i.isTouchEvent && De.activeElement && o.target === De.activeElement && e(o.target).is(i.formElements))
                    return i.isMoved = !0,
                    void (a.allowClick = !1);
                ...
                !(o.targetTouches && o.targetTouches.length > 1)) {
                    ...
                    if (!(a.params.threshold && Math.sqrt(Math.pow(p, 2) + Math.pow(c, 2)) < a.params.threshold)) {
                        if (void 0 === i.isScrolling) {
                            var u;
                            a.isHorizontal() && s.currentY === s.startY || a.isVertical() && s.currentX === s.startX ? i.isScrolling = !1 : p * p + c * c >= 25 && (u = 180 * Math.atan2(Math.abs(c), Math.abs(p)) / Math.PI,
                        ...
                        if (i.startMoving) {
                            ...
                            r.resistance && (i.currentTranslate = a.minTranslate() - 1 + Math.pow(-a.minTranslate() + i.startTranslate + h, f))) : h < 0 && i.currentTranslate < a.maxTranslate() && (v = !1,
                            r.resistance && (i.currentTranslate = a.maxTranslate() + 1 - Math.pow(a.maxTranslate() - i.startTranslate - h, f))),
        ...
        function we(e) {
            ...
            a.clickTimeout = He.nextTick(function() {
                t && !t.destroyed && t.emit("click", d)
            }, 300)),
            c < 300 && p - a.lastClickTime < 300 && (a.clickTimeout && clearTimeout(a.clickTimeout),
            t.emit("doubleTap", d))),
            a.lastClickTime = He.now(),
            He.nextTick(function() {
            ...
            a.startMoving = !1;
            var u;
            if (u = i.followFinger ? s ? t.translate : -t.translate : -a.currentTranslate,
            i.freeMode) {
                if (u < -t.minTranslate())
                ...
                if (i.freeModeMomentum) {
                    if (a.velocities.length > 1) {
                        ...
                        (m > 150 || He.now() - h.time > 300) && (t.velocity = 0)
                    } else
                        t.velocity = 0;
                    ...
                    var g = 1e3 * i.freeModeMomentumRatio
                      ...
                      , y = t.translate + b;
                    s && (y = -y);
                    var w, x, T = !1, E = 20 * Math.abs(t.velocity) * i.freeModeMomentumBounceRatio;
                    if (y < t.maxTranslate())
                    ...
                    0 !== t.velocity)
                        g = s ? Math.abs((-y - t.translate) / t.velocity) : Math.abs((y - t.translate) / t.velocity);
                    else if (i.freeModeSticky)
            ...
            for (var M = 0, k = t.slidesSizesGrid[0], P = 0; P < o.length; P += i.slidesPerGroup)
                void 0 !== o[P + i.slidesPerGroup] ? u >= o[P] && u < o[P + i.slidesPerGroup] && (M = P,
                k = o[P + i.slidesPerGroup] - o[P]) : u >= o[P] && (M = P,
                k = o[o.length - 1] - o[o.length - 2]);
            var $ = (u - o[M]) / k;
            if (c > i.longSwipesMs) {
                if (!i.longSwipes)
                    return void t.slideTo(t.activeIndex);
                "next" === t.swipeDirection && ($ >= i.longSwipesRatio ? t.slideTo(M + i.slidesPerGroup) : t.slideTo(M)),
                "prev" === t.swipeDirection && ($ > 1 - i.longSwipesRatio ? t.slideTo(M + i.slidesPerGroup) : t.slideTo(M))
            } else {
                if (!i.shortSwipes)
                    return void t.slideTo(t.activeIndex);
        ...
        function Ee() {
            ...
            if (Ge.touch || !Ge.pointerEvents && !Ge.prefixedPointerEvents) {
                if (Ge.touch) {
                    ...
                    s.addEventListener(a.move, e.onTouchMove, Ge.passiveListener ? {
                        passive: !1,
                        capture: n
                    } : n),
                    s.addEventListener(a.end, e.onTouchEnd, o)
                }
                (t.simulateTouch && !Ue.ios && !Ue.android || t.simulateTouch && !Ge.touch && Ue.ios) && (s.addEventListener("mousedown", e.onTouchStart, !1),
                De.addEventListener("mousemove", e.onTouchMove, n),
                De.addEventListener("mouseup", e.onTouchEnd, !1))
            } else
                s.addEventListener(a.start, e.onTouchStart, !1),
                De.addEventListener(a.move, e.onTouchMove, n),
                De.addEventListener(a.end, e.onTouchEnd, !1);
            (t.preventClicks || t.preventClicksPropagation) && s.addEventListener("click", e.onClick, !0),
            e.on(Ue.ios || Ue.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", xe, !0)
        }
        function Se() {
            var e = this
              , t = e.params
            ...
            if (Ge.touch || !Ge.pointerEvents && !Ge.prefixedPointerEvents) {
                if (Ge.touch) {
                    ...
                    s.removeEventListener(a.move, e.onTouchMove, n),
                    s.removeEventListener(a.end, e.onTouchEnd, o)
                }
                (t.simulateTouch && !Ue.ios && !Ue.android || t.simulateTouch && !Ge.touch && Ue.ios) && (s.removeEventListener("mousedown", e.onTouchStart, !1),
                De.removeEventListener("mousemove", e.onTouchMove, n),
                De.removeEventListener("mouseup", e.onTouchEnd, !1))
            } else
                s.removeEventListener(a.start, e.onTouchStart, !1),
                De.removeEventListener(a.move, e.onTouchMove, n),
                De.removeEventListener(a.end, e.onTouchEnd, !1);
            (t.preventClicks || t.preventClicksPropagation) && s.removeEventListener("click", e.onClick, !0),
            e.off(Ue.ios || Ue.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", xe)
        }
        function Ce() {
            var e = this
              , t = e.activeIndex
        ...
        function Me(e) {
            ...
            if (e) {
                ...
                for (var r = 0; r < i.length; r += 1) {
                    var s = i[r];
                    t.params.breakpointsInverse ? s <= Oe.innerWidth && (a = s) : s >= Oe.innerWidth && !a && (a = s)
                }
                return a || "max"
            }
        }
        function ke() {
            ...
            Ge.flexbox || s.push("no-flexbox"),
            a.autoHeight && s.push("autoheight"),
            i && s.push("rtl"),
            a.slidesPerColumn > 1 && s.push("multirow"),
            Ue.android && s.push("android"),
            Ue.ios && s.push("ios"),
            (Be.isIE || Be.isEdge) && (Ge.pointerEvents || Ge.prefixedPointerEvents) && s.push("wp8-" + a.direction),
        ...
        function $e(e, t, a, i, r, s) {
            ...
            var o;
            e.complete && r ? n() : t ? (o = new Oe.Image,
            o.onload = n,
            o.onerror = n,
            i && (o.sizes = i),
            a && (o.srcset = a),
        ...
        function Le() {
            ...
            return !e && De.implementation && De.implementation.hasFeature && !0 !== De.implementation.hasFeature("", "") && (e = De.implementation.hasFeature("Events.wheel", "3.0")),
            e
        }
        var De = "undefined" == typeof document ? {
            body: {},
        ...
        var He = {
            ...
            getTranslate: function(e, t) {
                void 0 === t && (t = "x");
                var a, i, r, s = Oe.getComputedStyle(e, null);
                return Oe.WebKitCSSMatrix ? (i = s.transform || s.webkitTransform,
                i.split(",").length > 6 && (i = i.split(", ").map(function(e) {
                    return e.replace(",", ".")
                }).join(", ")),
                r = new Oe.WebKitCSSMatrix("none" === i ? "" : i)) : (r = s.MozTransform || s.OTransform || s.MsTransform || s.msTransform || s.transform || s.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"),
                a = r.toString().split(",")),
                "x" === t && (i = Oe.WebKitCSSMatrix ? r.m41 : 16 === a.length ? parseFloat(a[12]) : parseFloat(a[4])),
                "y" === t && (i = Oe.WebKitCSSMatrix ? r.m42 : 16 === a.length ? parseFloat(a[13]) : parseFloat(a[5])),
                i || 0
            },
            parseUrlQuery: function(e) {
                var t, a, i, r, s = {}, n = e || Oe.location.href;
            ...
            extend: function() {
                ...
                for (var a = Object(e[0]), i = 1; i < e.length; i += 1) {
                    var r = e[i];
                    if (void 0 !== r && null !== r)
                        for (var s = Object.keys(Object(r)), n = 0, o = s.length; n < o; n += 1) {
                            var l = s[n]
                              , d = Object.getOwnPropertyDescriptor(r, l);
                            void 0 !== d && d.enumerable && (He.isObject(a[l]) && He.isObject(r[l]) ? He.extend(a[l], r[l]) : !He.isObject(a[l]) && He.isObject(r[l]) ? (a[l] = {},
                            He.extend(a[l], r[l])) : a[l] = r[l])
                        }
                }
                return a
            }
          ...
          , Ge = function() {
            ...
            return {
                touch: Oe.Modernizr && !0 === Oe.Modernizr.touch || function() {
                    return !!(Oe.navigator.maxTouchPoints > 0 || "ontouchstart"in Oe || Oe.DocumentTouch && De instanceof Oe.DocumentTouch)
                }(),
                ...
                transforms3d: Oe.Modernizr && !0 === Oe.Modernizr.csstransforms3d || function() {
                    var t = e.style;
        ...
        Ye.prototype.on = function(e, t, a) {
            var i = this;
        ...
        ,
        Ye.prototype.once = function(e, t, a) {
            function i() {
        ...
        Ye.prototype.off = function(e, t) {
            ...
            return a.eventsListeners ? (e.split(" ").forEach(function(e) {
                void 0 === t ? a.eventsListeners[e] = [] : a.eventsListeners[e] && a.eventsListeners[e].length && a.eventsListeners[e].forEach(function(i, r) {
                    (i === t || i.f7proxy && i.f7proxy === t) && a.eventsListeners[e].splice(r, 1)
                })
            }),
            a) : a
        }
        ...
        var Xe = {
          ...
          , Ue = function() {
            var e = Oe.navigator.userAgent
              , t = {
                ...
                ipod: !1,
                ipad: !1,
                cordova: Oe.cordova || Oe.phonegap,
                phonegap: Oe.cordova || Oe.phonegap
            }
              , a = e.match(/(Windows Phone);?[\s\/]+([\d.]+)?/)
              , i = e.match(/(Android);?[\s\/]+([\d.]+)?/)
              , r = e.match(/(iPad).*OS\s([\d_]+)/)
              , s = e.match(/(iPod)(.*OS\s([\d_]+))?/)
              , n = !r && e.match(/(iPhone\sOS|iOS)\s([\d_]+)/);
            if (a && (t.os = "windows",
            t.osVersion = a[2],
            t.windows = !0),
            i && !a && (t.os = "android",
            ...
            (r || n || s) && (t.os = "ios",
            t.ios = !0),
            n && !s && (t.osVersion = n[2].replace(/_/g, "."),
            t.iphone = !0),
            ...
            t.webView = (n || r || s) && e.match(/.*AppleWebKit(?!.*Safari)/i),
            t.os && "ios" === t.os) {
                var o = t.osVersion.split(".")
                  , l = De.querySelector('meta[name="viewport"]');
                t.minimalUi = !t.webView && (s || n) && (1 * o[0] == 7 ? 1 * o[1] >= 1 : 1 * o[0] > 7) && l && l.getAttribute("content").indexOf("minimal-ui") >= 0
            }
            return t.pixelRatio = Oe.devicePixelRatio || 1,
            t
        }()
          , Ke = {
            attachEvents: Ee,
          ...
          , rt = function(t) {
            function a() {
                ...
                l.params = He.extend({}, d, it, o),
                l.originalParams = He.extend({}, l.params),
                l.passedParams = He.extend({}, o),
                l.$ = e;
                var p = e(l.params.el);
                if (n = p[0]) {
                    if (p.length > 1) {
                    ...
                    return He.extend(l, {
                        ...
                        touchEvents: function() {
                            ...
                            return Ge.pointerEvents ? t = ["pointerdown", "pointermove", "pointerup"] : Ge.prefixedPointerEvents && (t = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]),
                            l.touchEventsTouch = {
                                start: e[0],
                                move: e[1],
                                end: e[2]
            ...
            a.prototype.changeDirection = function(e, t) {
                ...
                e === i || "horizontal" !== e && "vertical" !== e ? a : (a.$el.removeClass("" + a.params.containerModifierClass + i + " wp8-" + i).addClass("" + a.params.containerModifierClass + e),
                (Be.isIE || Be.isEdge) && (Ge.pointerEvents || Ge.prefixedPointerEvents) && a.$el.addClass(a.params.containerModifierClass + "wp8-" + e),
          ...
          , lt = {
            ...
            on: {
                init: function() {
                    var e = this;
                    Oe.addEventListener("resize", e.resize.resizeHandler),
                    Oe.addEventListener("orientationchange", e.resize.orientationChangeHandler)
                },
                destroy: function() {
                    var e = this;
                    Oe.removeEventListener("resize", e.resize.resizeHandler),
                    Oe.removeEventListener("orientationchange", e.resize.orientationChangeHandler)
                }
            }
        }
          , dt = {
          ...
          , ct = {
            update: function(e) {
                ...
                var a = this
                  ...
                  , m = p.offset;
                a.updateActiveIndex();
                var g, b = a.activeIndex || 0;
                g = a.rtlTranslate ? "right" : a.isHorizontal() ? "left" : "top";
                var y, w;
                n ? (y = Math.floor(r / 2) + s + l,
                w = Math.floor(r / 2) + s + d) : (y = r + (s - 1) + l,
                w = s + d);
                var x = Math.max((b || 0) - w, 0)
                  , T = Math.min((b || 0) + y, h.length - 1)
                  , E = (a.slidesGrid[x] || 0) - (a.slidesGrid[0] || 0);
                if (He.extend(a.virtual, {
                    from: x,
                    to: T,
                    offset: E,
                ...
                c === x && u === T && !e)
                    return a.slidesGrid !== v && E !== m && a.slides.css(g, E + "px"),
                ...
                if (e)
                    ...
                    for (var M = c; M <= u; M += 1)
                        (M < x || M > T) && a.$wrapperEl.find("." + a.params.slideClass + '[data-swiper-slide-index="' + M + '"]').remove();
                for (var k = 0; k < h.length; k += 1)
                    k >= x && k <= T && (void 0 === u || e ? C.push(k) : (k > u && C.push(k),
                    k < c && S.push(k)));
            ...
            renderSlide: function(t, a) {
                var i = this
                  , r = i.params.virtual;
                if (r.cache && i.virtual.cache[a])
                    return i.virtual.cache[a];
                var s = e(r.renderSlide ? r.renderSlide.call(i, t, a) : '<div class="' + i.params.slideClass + '" data-swiper-slide-index="' + a + '">' + t + "</div>");
                return s.attr("data-swiper-slide-index") || s.attr("data-swiper-slide-index", a),
                r.cache && (i.virtual.cache[a] = s),
                s
            },
          ...
          , ht = {
            handle: function(e) {
                ...
                if (!t.allowSlidePrev && (t.isHorizontal() && 37 === r || t.isVertical() && 38 === r || 33 === r))
                    return !1;
                if (!(i.shiftKey || i.altKey || i.ctrlKey || i.metaKey || De.activeElement && De.activeElement.nodeName && ("input" === De.activeElement.nodeName.toLowerCase() || "textarea" === De.activeElement.nodeName.toLowerCase()))) {
                    if (t.params.keyboard.onlyInViewport && (33 === r || 34 === r || 37 === r || 39 === r || 38 === r || 40 === r)) {
                        ...
                        for (var d = [[l.left, l.top], [l.left + t.width, l.top], [l.left, l.top + t.height], [l.left + t.width, l.top + t.height]], p = 0; p < d.length; p += 1) {
                            var c = d[p];
                            c[0] >= 0 && c[0] <= n && c[1] >= 0 && c[1] <= o && (s = !0)
                        }
                        if (!s)
                            return
                    }
                    t.isHorizontal() ? (33 !== r && 34 !== r && 37 !== r && 39 !== r || (i.preventDefault ? i.preventDefault() : i.returnValue = !1),
                    (34 !== r && 39 !== r || a) && (33 !== r && 37 !== r || !a) || t.slideNext(),
                    (33 !== r && 37 !== r || a) && (34 !== r && 39 !== r || !a) || t.slidePrev()) : (33 !== r && 34 !== r && 38 !== r && 40 !== r || (i.preventDefault ? i.preventDefault() : i.returnValue = !1),
            ...
            enable: function() {
                var t = this;
                t.keyboard.enabled || (e(De).on("keydown", t.keyboard.handle),
                t.keyboard.enabled = !0)
            },
            disable: function() {
                var t = this;
                t.keyboard.enabled && (e(De).off("keydown", t.keyboard.handle),
          ...
          , ft = {
            ...
            handle: function(e) {
                ...
                if (i.forceToAxis)
                    ...
                    r = Math.abs(n.pixelX) > Math.abs(n.pixelY) ? -n.pixelX * s : -n.pixelY;
                if (0 === r)
                    return !0;
                if (i.invert && (r = -r),
                a.params.freeMode) {
                    ...
                    a.mousewheel.timeout = He.nextTick(function() {
                        a.slideToClosest()
                    }, 300)),
                    a.emit("scroll", t),
                    ...
                    if (He.now() - a.mousewheel.lastScrollTime > 60)
                        if (r < 0)
                            ...
                            a.slidePrev(),
                            a.emit("scroll", t);
                    a.mousewheel.lastScrollTime = (new Oe.Date).getTime()
                }
            ...
            enable: function() {
                ...
                a.on(ft.event, t.mousewheel.handle),
            ...
            disable: function() {
                ...
                var a = t.$el;
                return "container" !== t.params.mousewheel.eventsTarged && (a = e(t.params.mousewheel.eventsTarged)),
                a.off(ft.event, t.mousewheel.handle),
          ...
          , gt = {
            ...
            init: function() {
                ...
                if (a.nextEl || a.prevEl) {
                    ...
                    a.prevEl && (r = e(a.prevEl),
                    t.params.uniqueNavElements && "string" == typeof a.prevEl && r.length > 1 && 1 === t.$el.find(a.prevEl).length && (r = t.$el.find(a.prevEl))),
            ...
            on: {
                ...
                click: function(t) {
                    var a = this
                      ...
                      , r = i.$nextEl
                      , s = i.$prevEl;
                    if (a.params.navigation.hideOnClick && !e(t.target).is(s) && !e(t.target).is(r)) {
                        var n;
                        r ? n = r.hasClass(a.params.navigation.hiddenClass) : s && (n = s.hasClass(a.params.navigation.hiddenClass)),
                        !0 === n ? a.emit("navigationShow", a) : a.emit("navigationHide", a),
          ...
          , yt = {
            update: function() {
                ...
                if (i.el && t.pagination.el && t.pagination.$el && 0 !== t.pagination.$el.length) {
                    var r, s = t.virtual && t.params.virtual.enabled ? t.virtual.slides.length : t.slides.length, n = t.pagination.$el, o = t.params.loop ? Math.ceil((s - 2 * t.loopedSlides) / t.params.slidesPerGroup) : t.snapGrid.length;
                    if (t.params.loop ? (r = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup),
                    r > s - 1 - 2 * t.loopedSlides && (r -= s - 2 * t.loopedSlides),
                    r > o - 1 && (r -= o),
                    ...
                    "bullets" === i.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                        ...
                        if (i.dynamicBullets && (t.pagination.bulletSize = c.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
                        n.css(t.isHorizontal() ? "width" : "height", t.pagination.bulletSize * (i.dynamicMainBullets + 4) + "px"),
                        ...
                        n.length > 1)
                            c.each(function(t, a) {
                                ...
                                i.dynamicBullets && (n >= l && n <= d && s.addClass(i.bulletActiveClass + "-main"),
                                n === l && s.prev().addClass(i.bulletActiveClass + "-prev").prev().addClass(i.bulletActiveClass + "-prev-prev"),
                                n === d && s.next().addClass(i.bulletActiveClass + "-next").next().addClass(i.bulletActiveClass + "-next-next"))
                            });
                        else {
                            if (c.eq(r).addClass(i.bulletActiveClass),
                            i.dynamicBullets) {
                                for (var u = c.eq(l), h = c.eq(d), v = l; v <= d; v += 1)
                                    c.eq(v).addClass(i.bulletActiveClass + "-main");
                                u.prev().addClass(i.bulletActiveClass + "-prev").prev().addClass(i.bulletActiveClass + "-prev-prev"),
                    ...
                    if ("fraction" === i.type && (n.find("." + i.currentClass).text(i.formatFractionCurrent(r + 1)),
                    ...
                    "progressbar" === i.type) {
                        ...
                        n.find("." + i.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + w + ") scaleY(" + x + ")").transition(t.params.speed)
                    }
                    "custom" === i.type && i.renderCustom ? (n.html(i.renderCustom(t, r + 1, o)),
                    t.emit("paginationRender", t, n[0])) : t.emit("paginationUpdate", t, n[0]),
                    n[t.params.watchOverflow && t.isLocked ? "addClass" : "removeClass"](i.lockClass)
                }
            },
            render: function() {
                var e = this
                ...
                if (t.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                    var a = e.virtual && e.params.virtual.enabled ? e.virtual.slides.length : e.slides.length
                      ...
                      , r = "";
                    if ("bullets" === t.type) {
                        for (var s = e.params.loop ? Math.ceil((a - 2 * e.loopedSlides) / e.params.slidesPerGroup) : e.snapGrid.length, n = 0; n < s; n += 1)
          ...
          , wt = {
            ...
            on: {
                ...
                click: function(t) {
                    var a = this;
                    if (a.params.pagination.el && a.params.pagination.hideOnClick && a.pagination.$el.length > 0 && !e(t.target).hasClass(a.params.pagination.bulletClass)) {
                        !0 === a.pagination.$el.hasClass(a.params.pagination.hiddenClass) ? a.emit("paginationShow", a) : a.emit("paginationHide", a),
          ...
          , xt = {
            setTranslate: function() {
                ...
                if (e.params.scrollbar.el && e.scrollbar.el) {
                    ...
                    p = 0) : p + r > s && (d = s - p),
                    e.isHorizontal() ? (Ge.transforms3d ? n.transform("translate3d(" + p + "px, 0, 0)") : n.transform("translateX(" + p + "px)"),
                    n[0].style.width = d + "px") : (Ge.transforms3d ? n.transform("translate3d(0px, " + p + "px, 0)") : n.transform("translateY(" + p + "px)"),
            ...
            onDragEnd: function(e) {
                ...
                t.scrollbar.dragTimeout = He.nextTick(function() {
                    r.css("opacity", 0),
                    r.transition(400)
                }, 1e3)),
            ...
            enableDraggable: function() {
                ...
                if (e.params.scrollbar.el) {
                    var t = e.scrollbar
                      ...
                      , s = t.$el
                      , n = s[0]
                      , o = !(!Ge.passiveListener || !r.passiveListeners) && {
                        passive: !1,
                        capture: !1
                    }
                    ...
                    Ge.touch ? (n.addEventListener(a.start, e.scrollbar.onDragStart, o),
                    n.addEventListener(a.move, e.scrollbar.onDragMove, o),
                    n.addEventListener(a.end, e.scrollbar.onDragEnd, l)) : (n.addEventListener(i.start, e.scrollbar.onDragStart, o),
                    De.addEventListener(i.move, e.scrollbar.onDragMove, o),
                    De.addEventListener(i.end, e.scrollbar.onDragEnd, l))
                }
            },
            disableDraggable: function() {
                ...
                if (e.params.scrollbar.el) {
                    ...
                    Ge.touch ? (n.removeEventListener(a.start, e.scrollbar.onDragStart, o),
                    n.removeEventListener(a.move, e.scrollbar.onDragMove, o),
                    n.removeEventListener(a.end, e.scrollbar.onDragEnd, l)) : (n.removeEventListener(i.start, e.scrollbar.onDragStart, o),
                    De.removeEventListener(i.move, e.scrollbar.onDragMove, o),
                    De.removeEventListener(i.end, e.scrollbar.onDragEnd, l))
                }
            },
            init: function() {
                var t = this;
                if (t.params.scrollbar.el) {
                    ...
                    0 === n.length && (n = e('<div class="' + t.params.scrollbar.dragClass + '"></div>'),
                    s.append(n)),
                    He.extend(a, {
                        $el: s,
                        el: s[0],
          ...
          , Et = {
            ...
            setTranslate: function() {
                var t = this
                  ...
                  , r = t.progress
                  , s = t.snapGrid;
                a.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(function(e, a) {
                    t.parallax.setTransform(a, r)
                }),
                i.each(function(a, i) {
                    var n = i.progress;
                    t.params.slidesPerGroup > 1 && "auto" !== t.params.slidesPerView && (n += Math.ceil(a / 2) - r * (s.length - 1)),
                    n = Math.min(Math.max(n, -1), 1),
                    e(i).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(function(e, a) {
            ...
            setTransition: function(t) {
                void 0 === t && (t = this.params.speed),
                this.$el.find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(function(a, i) {
                    var r = e(i)
          ...
          , Ct = {
            ...
            onGestureStart: function(t) {
                ...
                !Ge.gestures) {
                    ...
                    s.scaleStart = Ct.getDistanceBetweenTouches(t)
                }
                if (!(s.$slideEl && s.$slideEl.length || (s.$slideEl = e(t.target).closest(".swiper-slide"),
            ...
            onGestureChange: function(e) {
                ...
                if (!Ge.gestures) {
                    ...
                    r.scaleMove = Ct.getDistanceBetweenTouches(e)
                }
                r.$imageEl && 0 !== r.$imageEl.length && (Ge.gestures ? i.scale = e.scale * i.currentScale : i.scale = r.scaleMove / r.scaleStart * i.currentScale,
            ...
            onGestureEnd: function(e) {
                ...
                r.$imageEl && 0 !== r.$imageEl.length && (i.scale = Math.max(Math.min(i.scale, r.maxRatio), a.minRatio),
            ...
            onTouchStart: function(e) {
                var t = this
                  ...
                  , i = a.gesture
                  , r = a.image;
                i.$imageEl && 0 !== i.$imageEl.length && (r.isTouched || (Ue.android && e.preventDefault(),
                r.isTouched = !0,
            ...
            onTouchMove: function(e) {
                ...
                r.isTouched && i.$slideEl)) {
                    ...
                    r.startX = He.getTranslate(i.$imageWrapEl[0], "x") || 0,
                    r.startY = He.getTranslate(i.$imageWrapEl[0], "y") || 0,
            ...
            in: function(t) {
                var a = this
                  ...
                  , s = i.gesture
                  , n = i.image;
                if (s.$slideEl || (s.$slideEl = a.clickedSlide ? e(a.clickedSlide) : a.slides.eq(a.activeIndex),
                s.$imageEl = s.$slideEl.find("img, svg, canvas"),
                s.$imageWrapEl = s.$imageEl.parent("." + r.containerClass)),
                s.$imageEl && 0 !== s.$imageEl.length) {
                    s.$slideEl.addClass("" + r.zoomedSlideClass);
                    var o, l, d, p, c, u, h, v, f, m, g, b, y, w, x, T, E, S;
                    ...
                    t ? (E = s.$slideEl[0].offsetWidth,
                    S = s.$slideEl[0].offsetHeight,
                    d = s.$slideEl.offset().left,
                    p = s.$slideEl.offset().top,
                    c = d + E / 2 - o,
                    u = p + S / 2 - l,
                    ...
                    v > T && (v = T)) : (h = 0,
                    v = 0),
                    s.$imageWrapEl.transition(300).transform("translate3d(" + h + "px, " + v + "px,0)"),
            ...
            out: function() {
                ...
                r.$imageEl && 0 !== r.$imageEl.length && (a.scale = 1,
                a.currentScale = 1,
            ...
            enable: function() {
                ...
                if (!t.enabled) {
                    ...
                    Ge.gestures ? (e.$wrapperEl.on("gesturestart", ".swiper-slide", t.onGestureStart, a),
            ...
            disable: function() {
                ...
                if (t.enabled) {
                    ...
                    Ge.gestures ? (e.$wrapperEl.off("gesturestart", ".swiper-slide", t.onGestureStart, a),
          ...
          , kt = {
            loadInSlide: function(t, a) {
                ...
                if (void 0 !== t && 0 !== i.slides.length) {
                    var s = i.virtual && i.params.virtual.enabled
                      , n = s ? i.$wrapperEl.children("." + i.params.slideClass + '[data-swiper-slide-index="' + t + '"]') : i.slides.eq(t)
                      , o = n.find("." + r.elementClass + ":not(." + r.loadedClass + "):not(." + r.loadingClass + ")");
                    !n.hasClass(r.elementClass) || n.hasClass(r.loadedClass) || n.hasClass(r.loadingClass) || (o = o.add(n[0])),
            ...
            load: function() {
                function t(e) {
                    if (l) {
                        if (r.children("." + s.slideClass + '[data-swiper-slide-index="' + e + '"]').length)
                            return !0
                    } else if (n[e])
                        return !0;
                    return !1
                ...
                i.params.watchSlidesVisibility)
                    r.children("." + s.slideVisibleClass).each(function(t, a) {
                ...
                if (d.loadPrevNext)
                    if (p > 1 || d.loadPrevNextAmount && d.loadPrevNextAmount > 1) {
                        ...
                        var b = r.children("." + s.slideNextClass);
          ...
          , $t = {
            ...
            setTranslate: function(e, t) {
                ...
                var i, r, s = this, n = s.controller.control;
                if (Array.isArray(n))
                    for (var o = 0; o < n.length; o += 1)
                        n[o] !== t && n[o]instanceof rt && a(n[o]);
                else
                    n instanceof rt && t !== n && a(n)
            },
            setTransition: function(e, t) {
                function a(t) {
                    t.setTransition(e, r),
                    0 !== e && (t.transitionStart(),
                    t.params.autoHeight && He.nextTick(function() {
                        t.updateAutoHeight()
                    }),
                    t.$wrapperEl.transitionEnd(function() {
                        s && (t.params.loop && "slide" === r.params.controller.by && t.loopFix(),
                        t.transitionEnd())
                    }))
                }
                var i, r = this, s = r.controller.control;
                if (Array.isArray(s))
                    for (i = 0; i < s.length; i += 1)
                        s[i] !== t && s[i]instanceof rt && a(s[i]);
                else
                    s instanceof rt && t !== s && a(s)
            }
        }
          , zt = {
            name: "controller",
          ...
          , It = {
            ...
            onEnterKey: function(t) {
                ...
                if (13 === t.keyCode) {
                    var r = e(t.target);
                    a.navigation && a.navigation.$nextEl && r.is(a.navigation.$nextEl) && (a.isEnd && !a.params.loop || a.slideNext(),
                    a.isEnd ? a.a11y.notify(i.lastSlideMessage) : a.a11y.notify(i.nextSlideMessage)),
                    a.navigation && a.navigation.$prevEl && r.is(a.navigation.$prevEl) && (a.isBeginning && !a.params.loop || a.slidePrev(),
                    a.isBeginning ? a.a11y.notify(i.firstSlideMessage) : a.a11y.notify(i.prevSlideMessage)),
                    a.pagination && r.is("." + a.params.pagination.bulletClass) && r[0].click()
                }
            },
            notify: function(e) {
                var t = this
            ...
            updatePagination: function() {
                ...
                t.pagination && t.params.pagination.clickable && t.pagination.bullets && t.pagination.bullets.length && t.pagination.bullets.each(function(i, r) {
                    ...
                    t.a11y.addElLabel(s, a.paginationBulletMessage.replace(/{{index}}/, s.index() + 1))
                })
            },
            init: function() {
                var e = this;
          ...
          , Dt = {
            init: function() {
                var e = this;
                if (e.params.history) {
                    if (!Oe.history || !Oe.history.pushState)
                        return e.params.history.enabled = !1,
                        void (e.params.hashNavigation.enabled = !0);
                    var t = e.history;
                    t.initialized = !0,
                    t.paths = Dt.getPathValues(),
                    (t.paths.key || t.paths.value) && (t.scrollToSlide(0, t.paths.value, e.params.runCallbacksOnInit),
                    e.params.history.replaceState || Oe.addEventListener("popstate", e.history.setHistoryPopState))
                }
            },
            destroy: function() {
                var e = this;
            ...
            getPathValues: function() {
                var e = Oe.location.pathname.slice(1).split("/").filter(function(e) {
                    return "" !== e
                })
                  , t = e.length;
                return {
            ...
            setHistory: function(e, t) {
                ...
                if (a.history.initialized && a.params.history.enabled) {
                    var i = a.slides.eq(t)
                      , r = Dt.slugify(i.attr("data-history"));
                    Oe.location.pathname.includes(e) || (r = e + "/" + r);
                    var s = Oe.history.state;
                    s && s.value === r || (a.params.history.replaceState ? Oe.history.replaceState({
                        value: r
                    }, null, r) : Oe.history.pushState({
                        value: r
                    }, null, r))
                }
            },
          ...
          , At = {
            ...
            setHash: function() {
                ...
                if (e.hashNavigation.initialized && e.params.hashNavigation.enabled)
                    if (e.params.hashNavigation.replaceState && Oe.history && Oe.history.replaceState)
                        Oe.history.replaceState(null, null, "#" + e.slides.eq(e.activeIndex).attr("data-hash") || "");
                    else {
            ...
            init: function() {
                ...
                if (!(!t.params.hashNavigation.enabled || t.params.history && t.params.history.enabled)) {
                    ...
                    var a = De.location.hash.replace("#", "");
                    if (a)
                        for (var i = 0, r = t.slides.length; i < r; i += 1) {
                            var s = t.slides.eq(i)
                              , n = s.attr("data-hash") || s.attr("data-history");
                            if (n === a && !s.hasClass(t.params.slideDuplicateClass)) {
                                var o = s.index();
          ...
          , Vt = {
            setTranslate: function() {
                var t, a = this, i = a.$el, r = a.$wrapperEl, s = a.slides, n = a.width, o = a.height, l = a.rtlTranslate, d = a.size, p = a.params.cubeEffect, c = a.isHorizontal(), u = a.virtual && a.params.virtual.enabled, h = 0;
                p.shadow && (c ? (t = r.find(".swiper-cube-shadow"),
                ...
                for (var v = 0; v < s.length; v += 1) {
                    ...
                    m % 4 == 0 ? (w = 4 * -b * d,
                    T = 0) : (m - 1) % 4 == 0 ? (w = 0,
                    T = 4 * -b * d) : (m - 2) % 4 == 0 ? (w = d + 4 * b * d,
                    T = d) : (m - 3) % 4 == 0 && (w = -d,
                    T = 3 * d + 4 * d * b),
                    l && (w = -w),
                    c || (x = w,
                    w = 0);
                    var E = "rotateX(" + (c ? 0 : -g) + "deg) rotateY(" + (c ? g : 0) + "deg) translate3d(" + w + "px, " + x + "px, " + T + "px)";
                ...
                p.shadow)
                    if (c)
                        ...
                        var M = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90)
                          ...
                          , $ = p.shadowScale / k
                          , z = p.shadowOffset;
                        t.transform("scale3d(" + P + ", 1, " + $ + ") translate3d(0px, " + (o / 2 + z) + "px, " + -o / 2 / $ + "px) rotateX(-90deg)")
                    }
                var I = Be.isSafari || Be.isUiWebView ? -d / 2 : 0;
                r.transform("translate3d(0px,0," + I + "px) rotateX(" + (a.isHorizontal() ? 0 : h) + "deg) rotateY(" + (a.isHorizontal() ? -h : 0) + "deg)")
            },
            setTransition: function(e) {
                var t = this
                  , a = t.$el;
          ...
          , Ft = {
            setTranslate: function() {
                for (var t = this, a = t.slides, i = t.rtlTranslate, r = 0; r < a.length; r += 1) {
                    var s = a.eq(r)
                      , n = s[0].progress;
                    ...
                    t.params.flipEffect.slideShadows) {
                        ...
                        0 === h.length && (h = e('<div class="swiper-slide-shadow-' + (t.isHorizontal() ? "left" : "top") + '"></div>'),
                        s.append(h)),
                        0 === v.length && (v = e('<div class="swiper-slide-shadow-' + (t.isHorizontal() ? "right" : "bottom") + '"></div>'),
                        s.append(v)),
                        h.length && (h[0].style.opacity = Math.max(-n, 0)),
                        v.length && (v[0].style.opacity = Math.max(n, 0))
                    }
                    s.transform("translate3d(" + c + "px, " + u + "px, 0px) rotateX(" + p + "deg) rotateY(" + d + "deg)")
                }
            },
            setTransition: function(e) {
                var t = this
          ...
          , Wt = {
            setTranslate: function() {
                for (var t = this, a = t.width, i = t.height, r = t.slides, s = t.$wrapperEl, n = t.slidesSizesGrid, o = t.params.coverflowEffect, l = t.isHorizontal(), d = t.translate, p = l ? a / 2 - d : i / 2 - d, c = l ? o.rotate : -o.rotate, u = o.depth, h = 0, v = r.length; h < v; h += 1) {
                    var f = r.eq(h)
                      , m = n[h]
          ...
          , qt = {
            init: function() {
                ...
                He.extend(e.thumbs.swiper.originalParams, {
                    watchSlidesProgress: !0,
                    slideToClickedSlide: !1
                }),
                He.extend(e.thumbs.swiper.params, {
                    watchSlidesProgress: !0,
                    slideToClickedSlide: !1
                })) : He.isObject(a.swiper) && (e.thumbs.swiper = new i(He.extend({}, a.swiper, {
            ...
            onThumbClick: function() {
                ...
                if (a) {
                    ...
                    if (!(r && e(r).hasClass(t.params.thumbs.slideThumbActiveClass) || void 0 === i || null === i)) {
                        var s;
                        if (s = a.params.loop ? parseInt(e(a.clickedSlide).attr("data-swiper-slide-index"), 10) : i,
                        t.params.loop) {
                            var n = t.activeIndex;
                            t.slides.eq(n).hasClass(t.params.slideDuplicateClass) && (t.loopFix(),
                            t._clientLeft = t.$wrapperEl[0].clientLeft,
                            n = t.activeIndex);
                            var o = t.slides.eq(n).prevAll('[data-swiper-slide-index="' + s + '"]').eq(0).index()
                              , l = t.slides.eq(n).nextAll('[data-swiper-slide-index="' + s + '"]').eq(0).index();
                            s = void 0 === o ? l : void 0 === l ? o : l - n < n - o ? l : o
                        }
                        t.slideTo(s)
                    }
                }
            ...
            update: function(e) {
                ...
                if (a) {
                    ...
                    if (t.realIndex !== a.realIndex) {
                        var r, s = a.activeIndex;
                        if (a.params.loop) {
                            a.slides.eq(s).hasClass(a.params.slideDuplicateClass) && (a.loopFix(),
                            a._clientLeft = a.$wrapperEl[0].clientLeft,
                            s = a.activeIndex);
                            var n = a.slides.eq(s).prevAll('[data-swiper-slide-index="' + t.realIndex + '"]').eq(0).index()
                              , o = a.slides.eq(s).nextAll('[data-swiper-slide-index="' + t.realIndex + '"]').eq(0).index();
                            r = void 0 === n ? o : void 0 === o ? n : o - s == s - n ? s : o - s < s - n ? o : n
                        } else
                            r = t.realIndex;
                        a.visibleSlidesIndexes && a.visibleSlidesIndexes.indexOf(r) < 0 && (a.params.centeredSlides ? r = r > s ? r - Math.floor(i / 2) + 1 : r + Math.floor(i / 2) - 1 : r > s && (r = r - i + 1),
          ...
          , Ut = [st, nt, ot, lt, pt, ut, vt, mt, bt, wt, Tt, St, Mt, Pt, zt, Lt, Ot, Nt, Gt, Yt, Xt, Rt, jt, _t];
        return void 0 === rt.use && (rt.use = rt.Class.use,
    ...
    var r = function() {
      ...
      , o = function() {
        function e(t) {
            i(this, e),
            this.container = t,
            this.datepicker = new n.default(t),
        ...
        return r(e, [{
            ...
            value: function(e) {
                ...
                return $(e, this.container.parentElement)
            })
        }, {
            key: "bindEvents",
            value: function() {
                this.$(".editar_compromisso").prepOverlay({
                    ...
                    noform: function(e) {
                        return $.plonepopups.noformerrorshow(e, "redirect")
                    },
